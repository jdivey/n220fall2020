...
function createScene() {
    ...
    //setup ball
    ball = BABYLON.MeshBuilder.CreateSphere("sphereo", {diameter: 1}, scene);
    ball.physicsImpostor = new BABYLON.PhysicsImpostor(
        ball, BABYLON.PhysicsImpostor.SphereImpostor,
        {mass: 1, restitutuion: .2 }, scene);
    ...
    particleSystem.particleTexture = new BABYLON.Texture("images/particle.img", scene);
